...
def plot_amplitude_phase_meas_retreival(retrieved_obj, title, plot_spherical_aperture=False,ACTUAL=False,m_index=None,mask=False):
    ...
    retrieved_complex_normalized = retrieved_obj['real_output']+1j*retrieved_obj['imag_output']
    retrieved_complex_normalized*=1/(np.max(np.abs(retrieved_complex_normalized)))
