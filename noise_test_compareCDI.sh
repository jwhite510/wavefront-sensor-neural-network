...
cd ../..
python CompareNN_MatlabBilinearInterp.py --network noise_test_D_fixednorm_SQUARE6x6_VISIBLESETUP_NOCENTER_peak-50 --IMAGE_ANNOTATE _c_INF --SAVE_FOLDER test_7_6_cINF
...
do
	...
	cd ../..
	python CompareNN_MatlabBilinearInterp.py --network noise_test_D_fixednorm_SQUARE6x6_VISIBLESETUP_NOCENTER_peak-$pc --IMAGE_ANNOTATE _c_$pc --SAVE_FOLDER test_7_6_c$pc
done
